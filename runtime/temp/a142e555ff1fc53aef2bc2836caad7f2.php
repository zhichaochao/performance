<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\phpStudy\PHPTutorial\WWW\fsdfsdf\public/../application/admin\view\admin_user\index.html";i:1547175391;}*/ ?>
            ...
            <div class="bot clearfix">
                <table border="" cellspacing="" cellpadding="">
                    ...
                    <tr>
                        ...
                        <td><span>激活</span></td>
                        <td>
                            <button onclick="reset_password('传id')">重置密码</button>
                            <!-- 传id -->
                            <a class="edit_a" data-href="<?php echo \think\Url::build('admin_user/editmembera'); ?>&id=3" data-nav="<?php echo \think\Url::build('admin_user/nav'); ?>">修改</a>
                            <!--  -->
                            <button onclick="frozen_accoun('传id')">冻结</button>

                            <button class="del" onclick="delete_members('传id')" >删除</button>
                        </td>
                    </tr>
                    <tr>
                        <td><img src="img/grzx_02jpg.jpg"/></td>
