<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\phpStudy\WWW\tpadmin\public/../application/admin\view\pub\login.html";i:1546400337;}*/ ?>
﻿<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
    ...
    <body class="hei">
        <div class="login">
            <div class="logo">
                <a href="###"><img src="__STATIC__/img/png/logo3.png"/></a>
            </div>
            ...
            <div class="login_f">
                 <form class="form form-horizontal" action="<?php echo \think\Url::build('checkLogin'); ?>" method="post" id="form">
                    ...
                    <input class="in_sub" onclick="logink();" type="button" value="登录" />
                </form>
            </div>
